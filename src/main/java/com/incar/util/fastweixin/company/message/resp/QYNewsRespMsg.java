package com.incar.util.fastweixin.company.message.resp;

import com.incar.util.fastweixin.company.message.QYArticle;
import com.incar.util.fastweixin.message.Article;
import com.incar.util.fastweixin.message.RespType;

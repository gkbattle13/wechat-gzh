...
import com.incar.util.fastweixin.company.api.entity.QYUser;
import com.incar.util.fastweixin.company.api.enums.QYResultType;
import com.incar.util.fastweixin.company.api.response.GetOauthUserInfoResponse;
import com.incar.util.fastweixin.company.api.response.GetQYUserInfo4DepartmentResponse;
import com.incar.util.fastweixin.company.api.response.GetQYUserInfoResponse;
import com.incar.util.fastweixin.company.api.response.GetQYUserInviteResponse;
import com.incar.util.fastweixin.util.BeanUtil;

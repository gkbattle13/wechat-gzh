package com.incar.util.fastweixin.company.api.config;

import com.incar.util.fastweixin.api.config.ChangeType;
import com.incar.util.fastweixin.api.config.ConfigChangeNotice;
import com.incar.util.fastweixin.api.response.GetJsApiTicketResponse;
import com.incar.util.fastweixin.api.response.GetTokenResponse;
import com.incar.util.fastweixin.exception.WeixinException;
import com.incar.util.fastweixin.handle.ApiConfigChangeHandle;
import com.incar.util.fastweixin.util.JSONUtil;
import com.incar.util.fastweixin.util.NetWorkCenter;

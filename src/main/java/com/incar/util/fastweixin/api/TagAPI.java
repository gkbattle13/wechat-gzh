...
import com.incar.util.fastweixin.api.response.CreateTagResponse;
import com.incar.util.fastweixin.api.response.GetAllTagsResponse;
import com.incar.util.fastweixin.api.response.GetUsersResponse;

package com.incar.util.fastweixin.api;

import com.alibaba.fastjson.JSONArray;
import com.incar.util.fastweixin.api.config.ApiConfig;
import com.incar.util.fastweixin.api.entity.Industry;
import com.incar.util.fastweixin.api.entity.TemplateMsg;
import com.incar.util.fastweixin.api.enums.ResultType;
import com.incar.util.fastweixin.api.response.AddTemplateResponse;
import com.incar.util.fastweixin.api.response.BaseResponse;
import com.incar.util.fastweixin.api.response.PrivateTemplate;
import com.incar.util.fastweixin.api.response.SendTemplateResponse;
